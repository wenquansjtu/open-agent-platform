---
title: 'Custom Agents'
description: 'Building your own agents for the ForgeAI'
---

# Custom Agents

We built ForgeAI with custom agents in mind. Although we offer a few pre-built agents, we encourage you to build your own agents, and use OAP as a platform to prototype, test and use them! This guide will help you build agents that are compatible with all of ForgeAI's features.

## Overview

Building custom agents for ForgeAI involves three main steps:

1. Building your agent using LangGraph
2. Deploying your agent to LangGraph Platform or running it locally
3. Configuring your ForgeAI to connect to your deployed agent

## Why Build Custom Agents?

Building custom agents allows you to create specialized AI assistants that can be easily managed and used through the ForgeAI interface.
